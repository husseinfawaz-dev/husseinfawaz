...
const person = {
  ...
  role: "PhD Student, Software Engineer",
...
const newsletter = {
  ...
  description: (
    <>
      I occasionally write about technology, software engineering concepts and share thoughts on the
      intersection of machine learning and real-life applications.
    </>
  ),
};
...
const social = [
  ...
  //   name: "ResearchGate",
  //   icon: "researchgate"    ,
  //   link: "https://scholar.google.com/citations?user=qCON2h0AAAAJ&hl=en",
  // },
  {
    name: "Email",
    icon: "email",
...
const about = {
  ...
  intro: {
    ...
    description: (
      <>
        I am a seasoned software engineer with a diverse background spanning web
        development and network engineering. As a university lecturer, I have
        taught courses in different areas including Computer Networks,
    ...
    experiences: [
      {
        ...
        achievements: [
          "I am currently doing my research in ML for Cybersecurity and Trustworthy AI.",
        ],
        images: [
          {
  ...
  papers: [
    {
      ...
      authors:
        "Hussein Fawaz, Farhad Arpanaei, Davide Andreoletti, Ihab Sbeity, José Alberto Hernández, David Larrabeiti, Omran Ayoub.",
      conference:
        "International Conference on Optical Network Design and Modeling (ONDM).",
      link: "https://opendl.ifip-tc6.org/db/conf/ondm2024/ondm2024/1570996346.pdf",
    },
  ],
};
...
const blog = {
  label: "Blog",
  title: "Writing about the latest research in Machine Learning for Cybersecurity and Trustworthy AI.",
